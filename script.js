...
const TRANSLATIONS = {
  fr: {
    ...
    "about_p2": "Elle a été érigée en <strong>ONG</strong> par la signature de l'accord-cadre du <strong>25 juin 2019</strong> avec le Gouvernement de la République du Mali, puis modifié par l'avenant du <strong>13 février 2026</strong>. OPEN Mali est membre du Conseil Économique, Culturel et Social (ECOSOCC) de l'Union Africaine dont elle assure la présidence depuis Janvier 2025. Elle a le même statut consultatif de Conseil Économique et Social (ECOSOC) auprès des Nations Unies.",
    ...
    "about_commitment_title": "Domaines d'intervention & couverture géographique",
    "about_commitment_desc": "Les domaines d’intervention de l’association/ONG OPEN Mali sont :<br /><br />Éducation, Citoyenneté, Santé et Aide d’Urgence, Promotion et protection des droits des jeunes, Environnement, Résilience, Lutte contre la pauvreté, WASH, Assainissement, Action humanitaire, Activité génératrice de revenus (AGR), la Protection, Sécurité alimentaire, l’Agriculture, Paix, Cohésion sociale, Lutte contre les VBG, Nutrition, l’entreprenariat jeunes, Gouvernance, Abris, Etudes et recherches.",
    "about_values_title": "Nos Valeurs",
    "about_values_desc": "Les valeurs partagées par les membres de l’association/ONG OPEN Mali sont :<br />• L’altruisme : nous sommes au service des plus pauvres et nous les défendons ;<br />• L’équité envers tous ;<br />• La justice en toute impartialité ;<br />• Le professionnalisme.",
    ...
    "domains_subtitle": "De l'éducation des enfants à l'autonomisation des femmes et des jeunes, OPEN MALI intervient là où les besoins sont les plus criants.",
    "domain_edu_title": "Éducation & Protection",
    ...
    "domain_health_title": "Santé & Nutrition",
    ...
    "domain_cit_title": "Gouvernance & Citoyenneté",
    ...
    "domain_rights_title": "Promotion et Protection des Droits Humains",
    ...
    "domain_women_title": "Autonomisation des femmes et des jeunes",
    ...
    "don_use_1": "<strong>Parrainage scolaire par an</strong> – 35 000 FCFA<br /><strong>📓 Inscription</strong><br /><strong>📖 Kit Scolaire</strong><br /><strong>📋 Suivi</strong>",
    "don_use_2": "<strong>Don de vivre</strong> : Riz , mil , sucre , lait , huile",
    "don_use_3": "<strong>NFI</strong> :<br /><strong>🛏️ Kit de couchage :</strong> drap, natte, moustiquaire<br /><strong>🍳 Kit de cuisine :</strong> marmite , assiette , cuillère<br /><strong>🧼 Kit d'assainissement ( WASH ) :</strong> seaux , bouilloire , savon",
    ...
    "engage_subtitle": "Devenez bénévole ou contactez notre équipe pour construire ensemble l'avenir de la jeunesse malienne.",
    ...
    "proj_1_desc": "Programme de parrainage d'enfants vulnérables à 35 000 FCFA/enfant/an. Il couvre plusieurs régions du Mali avec un suivi individualisé de chaque enfant.",
    ...
    "transp_gov_ag": "L'Assemblée Générale",
    "transp_gov_ca": "Conseil d'Administration",
    "transp_gov_de": "Direction Exécutive",
  ...
  en: {
    ...
    "about_p2": "It was established as an <strong>NGO</strong> through the framework agreement signed on <strong>June 25, 2019</strong> with the Government of the Republic of Mali, subsequently updated by the amendment of <strong>February 13, 2026</strong>. OPEN Mali is a member of the Economic, Social and Cultural Council (ECOSOCC) of the African Union, holding its presidency since January 2025. It holds the same consultative status with the Economic and Social Council (ECOSOC) of the United Nations.",
    ...
    "about_commitment_title": "Areas of Intervention & Geographic Coverage",
    "about_commitment_desc": "The areas of intervention of the association/NGO OPEN Mali are:<br /><br />Education, Citizenship, Health and Emergency Relief, Promotion and protection of youth rights, Environment, Resilience, Poverty reduction, WASH, Sanitation, Humanitarian action, Income generating activities (IGA), Protection, Food security, Agriculture, Peace, Social cohesion, Fight against GBV, Nutrition, Youth entrepreneurship, Governance, Shelter, Studies and research.",
    "about_values_title": "Our Values",
    "about_values_desc": "The values shared by members of the association/NGO OPEN Mali are:<br />• Altruism: we are at the service of the poorest and defend them;<br />• Equity towards all;<br />• Impartial justice for all;<br />• Professionalism.",
    ...
    "domains_subtitle": "From children's education and women's and youth empowerment, OPEN MALI intervenes where the needs are most urgent.",
    "domain_edu_title": "Education & Protection",
    ...
    "domain_health_title": "Health & Nutrition",
    ...
    "domain_cit_title": "Governance & Citizenship",
    ...
    "domain_rights_title": "Promotion and Protection of Human Rights",
    ...
    "domain_women_title": "Empowerment of Women and Youth",
    ...
    "don_use_1": "<strong>Annual school sponsorship</strong> – 35,000 FCFA<br /><strong>📓 Registration</strong><br /><strong>📖 School Kit</strong><br /><strong>📋 Follow-up</strong>",
    "don_use_2": "<strong>Food Donation</strong>: Rice, millet, sugar, milk, oil",
    "don_use_3": "<strong>NFI</strong>:<br /><strong>🛏️ Bedding Kit:</strong> sheet, mat, mosquito net<br /><strong>🍳 Kitchen Kit:</strong> pot, plate, spoon<br /><strong>🧼 Sanitation Kit ( WASH ):</strong> buckets, kettle, soap",
    ...
    "engage_title": "Get Involved & Contact OPEN MALI",
    "engage_subtitle": "Become a volunteer or reach out to our team to build a brighter future for Malian youth together.",
    ...
    "proj_1_desc": "Sponsorship program for vulnerable children at 35,000 FCFA/child/year. Covering multiple regions of Mali with individualized child tracking.",
    ...
    "transp_gov_ag": "General Assembly",
    "transp_gov_ca": "Board of Directors",
    "transp_gov_de": "Executive Direction",
